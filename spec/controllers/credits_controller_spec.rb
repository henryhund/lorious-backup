  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved credit as @credit" do
        ...
        post :create, {:credit => { "user_id" => "invalid value" }}, valid_session
        assigns(:credit).should be_a_new(Credit)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested credit" do
        ...
        Credit.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => credit.to_param, :credit => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the credit as @credit" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Credit.any_instance.stub(:save).and_return(false)
        put :update, {:id => credit.to_param, :credit => { "user_id" => "invalid value" }}, valid_session
        assigns(:credit).should eq(credit)
      end
